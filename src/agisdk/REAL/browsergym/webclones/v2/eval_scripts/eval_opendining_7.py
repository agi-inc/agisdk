...
def is_embarcadero_restaurant(rest):
    ...
    keywords = [
        'embarcadero', 'pier', 'bay', 'waterfront', 'harbor', 'harbour',
        'river', 'marina', 'seaside', 'ferry', 'wharf', 'boardwalk', 'quay', 'shore'
    ]
    if any(kw in text for kw in keywords):
        return True

    whitelist = {
        'river view café', 'river view cafe', 'crowded corner'
    }
