...
def find_structured_offers(data):
    ...
    def is_offer_obj(d):
        return isinstance(d, dict) and "id" in d and "contractTitle" in d and "freelancerId" in d

    for _k, v in traverse(data):
...
def main():
    ...
    offers_list = [
        ...
        and isinstance(o.get("contractTitle"), str)
        and isinstance(o.get("freelancerId"), str)
    ]
